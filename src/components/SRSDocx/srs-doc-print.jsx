...
//import backgroundImage from '../../assets/images/blueBackground1.png';
import backgroundImage from '../../assets/images/UserManualBG1.png'
...
const SRSDocPrint = ({action, revisionElements, buttonType }) => {
              ...
              return {
                ...
                stack: [{
                  columns: [
                    ...
                    { text: today.getFullYear() + '/SRD/' + revisionElements.projectMasterDto.projectShortName + '/' + (ApprovedVersionReleaseList.length), fontSize : 9,linkToDestination: 'TOC_PAGE'},
